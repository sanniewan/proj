# This file is from external in src AtlasI2C.py
...
class AtlasI2C:
    ...
    def get_device_info(self):
        if(self._name == ""):
            return self._module + " " + str(self._address)
        else:
            return self._module + " " + str(self._address) + " " + self._name
    ...
    def read(self, num_of_bytes=31):
        ...
        if is_valid:
            ...
            result=''
            i = 0
            while i < len(char_list) and char_list[i] != '\x00':
